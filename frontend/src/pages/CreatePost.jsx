...
const CreatePost = () => {
    ...
    const handleCreate=async (e)=>{
        // this is to prevent automaatic refresh of the page
        e.preventDefault()
        const post={
          title,
          desc,
...
// if there is image then upload image first
        if(file){
          const data=new FormData()
        //   inside file img is saved as name attribute
  ...
  return (
    <div>
        ...
        {/* form of create post this for title */}
          ...
          <div className='flex flex-col'>
            ...
            {/* add category */}
                ...
                {/* click add button to push in categoryn array */}
