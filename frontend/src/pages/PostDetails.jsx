...
const PostDetails = () => {
    ...
    return (
        <div>
            <Navbar />
            {/* if loading show loader othger wise show the total [page] */}
            {loader ? <div className="h-[80vh] flex justify-center items-center w-full"><Loader /></div> : <div className="px-8 md:px-[200px] mt-8">
                <div className="flex justify-between items-center">
                    ...
                    {/* show the delete post an edit post to the user only so chexk condition first */}
                    {user?._id === post?.userId && <div className="flex items-center justify-center space-x-2">
                    {/* delete edit post icon */}
